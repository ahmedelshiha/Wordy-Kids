...
export function EnhancedChildProfileCard({
  ...
  const progressPercentage = Math.min((child.weeklyProgress / child.weeklyGoal) * 100, 100);
    ...
    return (
      <Card 
        className={cn(
          ...
          isSelected ? "border-purple-400 shadow-lg" : "border-gray-200 hover:border-purple-300",
          isPressed && "scale-95",
        ...
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              {child.currentStreak > 0 && (
                <div className="absolute -top-1 -right-1 w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center">
                  <span className="text-xs font-bold text-white">{child.currentStreak}</span>
                </div>
              )}
            </div>
            ...
            <div className="text-right">
              <div className="text-sm font-medium text-purple-600">{child.wordsLearned} words</div>
    ...
    return (
      <Card 
        className={cn(
          ...
          isSelected ? "border-purple-400 shadow-xl ring-2 ring-purple-200" : "border-gray-200 hover:border-purple-300",
      ...
      >
        ...
        <div className={cn(
          ...
          child.backgroundColor ? `bg-gradient-to-br ${child.backgroundColor}` : "bg-gradient-to-br from-purple-100 to-pink-100"
        )} />
        ...
        <CardContent className="relative p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="bg-white/60 rounded-lg p-3 backdrop-blur-sm">
              ...
              <div className="text-2xl font-bold text-blue-600">{child.wordsLearned}</div>
            </div>
            ...
            <div className="bg-white/60 rounded-lg p-3 backdrop-blur-sm">
              ...
              <div className="text-2xl font-bold text-yellow-600">{child.totalPoints.toLocaleString()}</div>
            </div>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-1">
                {child.interests.slice(0, 4).map((interest) => (
                  <Badge key={interest} variant="secondary" className="text-xs bg-white/60">
                    {interest}
                  </Badge>
                ))}
  ...
  return (
    <Card 
      className={cn(
        ...
        isSelected ? "border-purple-400 shadow-lg ring-2 ring-purple-200" : "border-gray-200 hover:border-purple-300",
        isPressed && "scale-95"
      )}
      onClick={handleCardClick}
    >
      ...
      <CardContent className="relative p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">{child.age} years • Level {child.level}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-3">
          <div className="text-center bg-white/60 rounded-lg p-2">
            <div className="text-lg font-bold text-blue-600">{child.wordsLearned}</div>
            <div className="text-xs text-gray-600">Words</div>
          </div>
          <div className="text-center bg-white/60 rounded-lg p-2">
            <div className="text-lg font-bold text-yellow-600">{child.totalPoints}</div>
            <div className="text-xs text-gray-600">Points</div>
          </div>
          <div className="text-center bg-white/60 rounded-lg p-2">
            <div className="text-lg font-bold text-green-600">{child.currentStreak}</div>
        ...
        <div className="mb-3">
          <div className="flex justify-between text-xs text-gray-600 mb-1">
            ...
            <span>{child.weeklyProgress}/{child.weeklyGoal}</span>
          </div>
          <div className="relative">
      ...
      <Card className="border-2 border-dashed border-gray-300 bg-gray-50">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Create your first child profile to start tracking their learning journey
          </p>
        </CardContent>
      </Card>
    );
