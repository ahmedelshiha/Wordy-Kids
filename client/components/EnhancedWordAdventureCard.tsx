    ...
    <div className={`relative w-full max-w-[380px] mx-auto ${className}`}>
      ...
      >
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-center space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={isPlaying}
                className={`text-white hover:bg-white/30 hover:scale-105 active:scale-95 p-4 h-auto min-w-[60px] min-h-[60px] rounded-full transition-all duration-200 border-2 border-white/40 bg-white/15 backdrop-blur-sm shadow-lg ${
              ...
              {funnyVoiceUnlocked && (
                <Button
                  ...
                  disabled={isPlaying}
                  className={`text-white hover:bg-white/30 hover:scale-105 active:scale-95 p-4 h-auto min-w-[60px] min-h-[60px] rounded-full transition-all duration-200 border-2 border-yellow-400/40 bg-yellow-400/15 backdrop-blur-sm shadow-lg ${
              ...
              {/* Sound Match Preview (Quick Game) */}
              {showSoundPreview && (
                <Button
                  size="sm"
                  variant="ghost"
                  ...
                  className="text-white hover:bg-white/30 p-3 rounded-full border border-white/40 bg-white/15 backdrop-blur-sm animate-bounce"
                >
        ...
        >
          ...
          <div className="space-y-3 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
            ...
            {word.funFact && (
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                <h4 className="text-sm font-medium mb-1 text-pink-300 flex items-center gap-1">
      ...
      {showSparkles && (
        <div className="absolute inset-0 pointer-events-none z-30 rounded-xl overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/20 via-transparent to-yellow-400/20 animate-ping"></div>
          <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-yellow-400 rounded-full animate-bounce"></div>
          <div className="absolute top-1/3 right-1/4 w-3 h-3 bg-blue-400 rounded-full animate-bounce animation-delay-100"></div>
          <div className="absolute bottom-1/3 left-1/3 w-2 h-2 bg-green-400 rounded-full animate-bounce animation-delay-200"></div>
          <div className="absolute bottom-1/4 right-1/3 w-2 h-2 bg-pink-400 rounded-full animate-bounce animation-delay-300"></div>
        </div>
      )}
