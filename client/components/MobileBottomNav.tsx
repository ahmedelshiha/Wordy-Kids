          ...
          <div className="flex items-center justify-around px-1 py-0.5">
            ...
            {primaryTabs.map((tab) => (
              <button
                ...
                className={cn(
                  "flex flex-col items-center gap-0 p-1 rounded-xl transition-all duration-200 transform active:scale-95 relative min-w-0 flex-1 mx-0.5 min-h-[40px] justify-center",
                  activeTab === tab.id
              ...
              >
                ...
                {/* Label */}
                <span className="text-base font-bold leading-none text-center truncate max-w-full">
                  {tab.label}
                </span>
            ...
            <button
              onClick={onMoreToggle}
              className={cn(
                "flex flex-col items-center gap-0.5 p-1.5 rounded-xl transition-all duration-200 transform active:scale-95 min-w-0 flex-1 mx-0.5 min-h-[50px] justify-center",
                showMoreMenu
