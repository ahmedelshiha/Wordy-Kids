...
const enrichedCategories: Category[] = [
  ...
  },
  {
    ...
    difficultyBreakdown: {
      easy: getWordsByCategory("adventure").filter(
        (w) => w.difficulty === "easy",
      ).length,
      medium: getWordsByCategory("adventure").filter(
        (w) => w.difficulty === "medium",
      ).length,
      hard: getWordsByCategory("adventure").filter(
        (w) => w.difficulty === "hard",
      ).length,
    },
  },
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
          ...
          Each category is packed with words, fun facts, and amazing
          discoveries!
        </p>
      </div>
        ...
        {categories.map((category) => (
          ...
          >
            <CardContent className="p-0 overflow-hidden">
              ...
              <div
                className={`bg-gradient-to-r ${category.gradient} p-6 text-white text-center`}
              >
