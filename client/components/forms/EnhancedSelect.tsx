                ...
                >
                  <Badge
                    ...
                    className={cn(
                      ...
                      colorfulOptions &&
                        option.category &&
                        "bg-gradient-to-r from-jungle/10 to-jungle/20",
                    )}
                  >
                          ...
                          return (
                            <motion.button
                              ...
                              className={cn(
                                ...
                                colorfulOptions &&
                                  "hover:bg-gradient-to-r hover:from-jungle/5 hover:to-jungle/10",
                              )}
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2">
                                    ...
                                    {option.popular && (
                                      <Badge
                                        variant="outline"
                                        className="text-xs px-1.5 py-0.5 bg-yellow-50 text-yellow-700 border-yellow-300"
                                      >
                                        ⭐ Popular
                                      </Badge>
                                    )}
                              ...
                              <div className="flex items-center gap-2 flex-shrink-0">
                                ...
                                {enableFavorites && (
                                  <button
                                    type="button"
                                    onClick={(e) =>
                                      handleFavoriteToggle(option.value, e)
                                    }
                                    className="p-1 hover:bg-gray-100 rounded-full transition-colors"
