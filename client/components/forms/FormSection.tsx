...
const FormSection: React.FC<FormSectionProps> = ({
  ...
  const renderContent = () => (
    <div className={cn(spacingStyles[spacing], "w-full")}>{children}</div>
  );
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {difficulty && (
                ...
                >
                  <span className="mr-1">
                    {difficultyIndicators[difficulty].emoji}
                  </span>
  ...
  switch (variant) {
    case "card":
      ...
      return (
        <motion.div className={className} id={id} {...motionProps}>
          <Card
            className={cn(
              "border-2",
              styles.border,
          ...
          >
            {(title || description || showProgress) && (
              <CardHeader className="pb-4">{renderHeader()}</CardHeader>
            )}
