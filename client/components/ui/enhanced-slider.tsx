        ...
        >
          ...
          <SliderPrimitive.Thumb
            className={cn(
              ...
              colorConfig.thumb,
              isDragging &&
                "scale-125 shadow-2xl ring-4 ring-offset-2 animate-none",
              // Enhanced focus styles by variant
              variant === "jungle" &&
                "focus-visible:ring-green-400 focus:ring-green-400",
              variant === "success" &&
                "focus-visible:ring-emerald-400 focus:ring-emerald-400",
              variant === "warning" &&
                "focus-visible:ring-amber-400 focus:ring-amber-400",
              variant === "default" &&
                "focus-visible:ring-blue-400 focus:ring-blue-400",
            )}
          />
