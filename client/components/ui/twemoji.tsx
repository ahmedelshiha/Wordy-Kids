...
export const AchievementTwemoji = {
  Trophy: ({
    className,
    size = 32,
  }: Omit<TwemojiProps, "emoji" | "ariaLabel">) => (
    <TwemojiSVG
      emoji="🏆"
...
export function AnimatedTwemoji({
  ...
  return (
    ...
    >
      <TwemojiSVG emoji={emoji} size={size} ariaLabel={ariaLabel} />
    </div>
  );
}
