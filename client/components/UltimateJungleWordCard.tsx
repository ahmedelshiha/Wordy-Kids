...
export const UltimateJungleWordCard: React.FC<UltimateJungleWordCardProps> = ({
  ...
  const defaultVocabulary: UltimateWord[] = [
    {
      id: 1, word: 'Lion', emoji: '🦁', category: 'animals',
    ...
    {
      id: 7, word: 'Treasure', emoji: '💎', category: 'objects',
    ...
    {
      id: 8, word: 'Rocket', emoji: '🚀', category: 'transport',
    ...
    {
      id: 9, word: 'Elephant', emoji: '🐘', category: 'animals',
    ...
    {
      id: 10, word: 'Phoenix', emoji: '🔥', category: 'fantasy',
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
        ...
        <div className="absolute bottom-10 right-10 text-xl animate-bounce delay-1000">⭐</div>
      </div>
      ...
      <div className="flex justify-between items-center mb-6 bg-white/90 backdrop-blur-sm rounded-3xl p-4 shadow-2xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="font-bold text-xl text-gray-800">{score} Points</div>
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className={cn(
              ...
              soundEnabled ? 'bg-green-500 text-white hover:bg-green-600' : 'bg-gray-300 text-gray-600 hover:bg-gray-400'
            )}
            size="sm"
          >
            <Volume2 size={20} />
          ...
          <div className="text-center">
            ...
            <div className="text-xs font-bold">{currentWordIndex + 1}/{vocabularyWords.length}</div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto mb-8">
        <Card className={cn(
          ...
          <div className="bg-white/20 backdrop-blur-sm p-4 border-b border-white/30">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className="text-2xl">🏠</div>
                <div className="text-white font-bold">{currentWord.habitat}</div>
              </div>
          ...
          <CardContent className="p-8 text-center text-white" onClick={handleCardClick}>
            {/* Emoji Display */}
            ...
            {(discoveryMode === 'learn' || (discoveryMode === 'quiz' && showDefinition)) && (
            ...
            <div className="flex justify-center gap-3 flex-wrap">
              ...
              <Button
                ...
                variant={favorites.includes(currentWord.id) ? "default" : "outline"}
                className={cn(
              ...
              >
                <Heart size={20} className={favorites.includes(currentWord.id) ? 'fill-current' : ''} />
      ...
      {showReward && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white rounded-3xl p-8 shadow-2xl text-center transform animate-bounce">
            ...
            <div className="text-xl text-gray-600">You mastered "{currentWord.word}"!</div>
          </div>
        </div>
      )}
