...
export default function Index({ initialProfile }: IndexProps) {
  ...
  // Move function declarations before useEffects to prevent temporal dead zone errors
  ...
  useEffect(() => {
    ...
    initializeWords();
  }, [selectedCategory, currentDashboardWords.length]); // generateFreshWords is stable due to useCallback
