...
const jungleWords = [
  {
    ...
    definition: "An exciting or unusual experience, especially a journey to explore new places!",
    example: "The brave explorer went on a jungle adventure to find hidden treasures.",
    funFact: "The word 'adventure' comes from Latin meaning 'to arrive' - just like arriving at new discoveries!",
    emoji: "🌿",
  ...
  },
  {
    ...
    definition: "A thick tropical forest with lots of trees, plants, and amazing animals!",
    example: "The colorful parrots and playful monkeys live happily in the jungle.",
    funFact: "Jungles are home to more than half of all the animals and plants on Earth!",
    emoji: "🌳",
    category: "nature",
  ...
  },
  {
    ...
    definition: "A brave person who travels to discover new places and learn exciting things!",
    example: "The young explorer used a map and compass to find the secret waterfall.",
    funFact: "Famous explorers discovered new continents and helped us learn about our amazing world!",
    emoji: "🧭",
    category: "people",
    difficulty: "medium" as const,
    masteryLevel: 60,
  },
  {
    ...
    definition: "Something so beautiful and amazing that it takes your breath away!",
    example: "The magnificent rainbow appeared after the jungle rain, painting the sky with colors.",
    funFact: "Magnificent comes from Latin meaning 'great-making' - it makes everything feel grand!",
    emoji: "✨",
  ...
  },
  {
    ...
    definition: "Finding something new and exciting that nobody knew about before!",
    example: "The greatest discovery in the jungle was a hidden cave full of sparkling crystals.",
    funFact: "Every day scientists make new discoveries that help us understand our world better!",
    emoji: "💎",
    category: "exploration",
    difficulty: "medium" as const,
    masteryLevel: 50,
...
export function JungleAdventureWordCardDemo() {
  ...
  const handleWordMastered = (wordId: number, rating: "easy" | "medium" | "hard") => {
    ...
    setAdventureStats(prev => ({
      ...
      explorerXP: prev.explorerXP + (rating === "easy" ? 100 : rating === "medium" ? 60 : 30),
      adventureLevel: Math.floor((prev.explorerXP + (rating === "easy" ? 100 : rating === "medium" ? 60 : 30)) / 200) + 1,
    }));
  };
  ...
  const prevWord = () => {
    setCurrentWordIndex((prev) => (prev - 1 + jungleWords.length) % jungleWords.length);
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-jungle-light via-green-50 to-emerald-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-10">
          ...
          <div className="absolute top-1/2 left-1/4 text-3xl animate-float-up">🐦</div>
          <div className="absolute top-1/3 right-1/3 text-5xl animate-gentle-bounce">🌸</div>
        </div>
        ...
        <div className="relative z-10 p-4 md:p-6">
              ...
              <div className="bg-gradient-to-r from-sunshine/20 to-bright-orange/20 backdrop-blur-md rounded-xl px-4 py-2 border border-yellow-400/30">
                <div className="flex items-center gap-3 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-yellow-800">Lv.{adventureStats.adventureLevel}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Star className="w-4 h-4 text-blue-600" />
                    <span className="font-semibold text-blue-800">{adventureStats.explorerXP} XP</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <TreePine className="w-4 h-4 text-green-600" />
                    <span className="font-semibold text-green-800">{adventureStats.wordsExplored} Explored</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg md:text-xl text-jungle-dark/80 max-w-3xl mx-auto">
              Experience the most immersive jungle adventure word learning system! 
              Perfect for both desktop and mobile explorers. 🦋🌳
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 px-4 pb-8">
          <div className={`max-w-6xl mx-auto ${deviceView === "mobile" ? "max-w-md" : ""}`}>
                    ...
                    <Card className="bg-white/20 backdrop-blur-md border border-white/30">
                      ...
                      <CardContent className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-jungle-dark">Immersive Jungle Theme</h4>
                            <p className="text-sm text-jungle-dark/70">Beautiful jungle-themed UI with animated particles and nature sounds</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-sunshine rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-jungle-dark">Adventure Level System</h4>
                            <p className="text-sm text-jungle-dark/70">Earn XP and level up as you master new words!</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-coral-red rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-jungle-dark">Mobile Optimized</h4>
                            <p className="text-sm text-jungle-dark/70">Perfect touch interactions and responsive design</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-playful-purple rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-jungle-dark">Enhanced Accessibility</h4>
                            <p className="text-sm text-jungle-dark/70">Screen reader support, high contrast, and reduced motion options</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-r from-sunshine/20 to-bright-orange/20 backdrop-blur-md border border-yellow-400/30">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <p className="text-sm text-orange-700">Difficulty</p>
                            <Badge className={`${
                              currentWord.difficulty === "easy" ? "bg-jungle" : 
                              currentWord.difficulty === "medium" ? "bg-sunshine" : "bg-coral-red"
                            } text-white`}>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs font-semibold text-orange-800">{currentWord.masteryLevel}%</span>
                            </div>
                          </div>
                          <div>
                            <p className="text-sm text-orange-700">Letters</p>
                            <span className="text-lg font-bold text-orange-800">{currentWord.word.length}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
          ...
          {[
            {
              ...
              description: "Beautiful jungle-themed design with animated particles, nature sounds, and magical effects",
              color: "from-jungle to-jungle-dark",
            },
            {
              icon: Crown,
              title: "Adventure Level System",
              description: "Earn XP, level up, and unlock explorer badges as you master new words",
              color: "from-sunshine to-bright-orange",
            },
            {
              icon: Smartphone,
              title: "Mobile Optimized",
              description: "Perfect touch interactions, responsive design, and mobile-first user experience",
              color: "from-sky to-sky-dark",
            },
            {
              icon: Volume2,
              title: "Enhanced Audio",
              description: "Jungle-themed sound effects, clear pronunciation, and immersive audio feedback",
              color: "from-playful-purple to-purple-600",
            },
            {
              icon: Star,
              title: "3D Flip Animation",
              description: "Smooth 3D card flipping with hardware acceleration and beautiful transitions",
              color: "from-coral-red to-red-600",
            },
            {
              icon: Heart,
              title: "Accessibility First",
              description: "Full screen reader support, high contrast modes, and reduced motion options",
              color: "from-pink-500 to-rose-600",
            },
          ].map((feature, index) => (
            <Card key={index} className="bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-bold text-jungle-dark mb-2">{feature.title}</h3>
                <p className="text-sm text-jungle-dark/70">{feature.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center">
              <div className="bg-gradient-to-br from-jungle/10 to-emerald-600/10 rounded-2xl p-6 mb-4 border border-jungle/20">
                ...
                <h3 className="text-xl font-bold text-jungle-dark mb-2">Desktop Experience</h3>
                <p className="text-jungle-dark/70">Large, beautiful cards with detailed information panels and smooth hover effects</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-br from-sunshine/10 to-orange-600/10 rounded-2xl p-6 mb-4 border border-sunshine/20">
                ...
                <h3 className="text-xl font-bold text-jungle-dark mb-2">Mobile Experience</h3>
                <p className="text-jungle-dark/70">Touch-optimized interface with haptic feedback and optimized performance</p>
              </div>
            </div>
          </div>
        </div>
