  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-educational-blue-light via-educational-purple-light to-educational-pink-light flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-20 right-16 text-5xl animate-pulse delay-200">📚</div>
        <div className="absolute bottom-20 left-16 text-6xl animate-bounce delay-500">🎯</div>
        <div className="absolute bottom-10 right-20 text-5xl animate-pulse delay-700">🚀</div>
        <div className="absolute top-1/2 left-8 text-4xl animate-spin" style={{ animationDuration: "4s" }}>✨</div>
        <div className="absolute top-1/3 right-8 text-4xl animate-bounce delay-300">🎪</div>
        <div className="absolute bottom-1/3 left-1/4 text-3xl animate-pulse delay-900">🌈</div>
        <div className="absolute top-1/4 right-1/4 text-4xl animate-bounce delay-600">🎨</div>
        <div className="absolute top-3/4 left-1/3 text-3xl animate-pulse delay-1100">🎭</div>
        <div className="absolute top-1/6 left-2/3 text-4xl animate-bounce delay-400">🎪</div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <CardContent className="p-12 text-center">
              {/* Icon */}
              <div className="mb-8">
                <div className={`w-32 h-32 mx-auto rounded-full bg-gradient-to-r from-educational-green to-educational-blue flex items-center justify-center shadow-2xl transition-all duration-300 ${
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Start your amazing vocabulary journey! Create your profile, choose your learning buddy, and begin exploring the wonderful world of words.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center justify-center gap-3 text-educational-green">
                  ...
                  <span className="font-semibold">Create Your Adventure Profile</span>
                </div>
                <div className="flex items-center justify-center gap-3 text-educational-blue">
                  <Star className="w-5 h-5 fill-current" />
                  <span className="font-semibold">Choose Your Learning Buddy</span>
                </div>
                <div className="flex items-center justify-center gap-3 text-educational-purple">
                  <Star className="w-5 h-5 fill-current" />
                  <span className="font-semibold">Start Learning Right Away</span>
                </div>
              </div>
          ...
          >
            <CardContent className="p-12 text-center">
              {/* Icon */}
              <div className="mb-8">
                <div className={`w-32 h-32 mx-auto rounded-full bg-gradient-to-r from-educational-purple to-educational-pink flex items-center justify-center shadow-2xl transition-all duration-300 ${
              ...
              {/* Description */}
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Welcome back, word explorer! Continue your vocabulary adventure where you left off and discover even more amazing words.
              </p>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center justify-center gap-3 text-educational-pink">
                  <Star className="w-5 h-5 fill-current" />
                  <span className="font-semibold">Access Your Achievements</span>
                </div>
                <div className="flex items-center justify-center gap-3 text-educational-blue">
                  <Star className="w-5 h-5 fill-current" />
                  <span className="font-semibold">Keep Your Learning Streak</span>
                </div>
              </div>
