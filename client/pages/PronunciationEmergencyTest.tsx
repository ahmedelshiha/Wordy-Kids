  ...
  const testSpecificInput = async (input: any, label: string) => {
    ...
    try {
      ...
      if (sanitized) {
        ...
        setTestResults((prev) => [
          ...prev,
          { label, status: "pass", input, sanitized },
        ]);
      } else {
      ...
      setTestResults((prev) => [
        ...prev,
        { label, status: "error", input, error: String(error) },
      ]);
    }
  };
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">
                    ({typeof result.input}){" "}
                    {Array.isArray(result.input) ? "[Array]" : ""}
                  </span>
                </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <strong>Window Speech Synthesis:</strong>{" "}
        ...
        <div className="container mx-auto py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Comprehensive testing tool for debugging "[object Object]" and
