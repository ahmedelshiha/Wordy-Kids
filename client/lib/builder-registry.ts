...
const JungleKidNav = importComponent('../components/JungleKidNav', 'JungleKidNav')
...
const SettingsPanel = importComponent('../components/SettingsPanel', 'SettingsPanel')
const AchievementBadge = importComponent('../components/AchievementBadge', 'AchievementBadge')
const ProgressTracker = importComponent('../components/ProgressTracker', 'ProgressTracker')
const InteractiveQuiz = importComponent('../components/InteractiveQuiz', 'InteractiveQuiz')
const ParentDashboard = importComponent('../components/ParentDashboard', 'ParentDashboard')
const AIWordRecommendation = importComponent('../components/AIWordRecommendation', 'AIWordRecommendation')
...
Builder.registerComponent(JungleKidNav, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F7b3bb6b7d6d54c8a8f2e1c4f8a9e2b3c',
  inputs: [
    {
      name: 'user',
      type: 'object',
...
Builder.registerComponent(WordCard, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p',
  inputs: [
    {
      name: 'word',
      type: 'string',
...
Builder.registerComponent(WordGarden, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p7q',
  inputs: [
    {
      name: 'wordList',
      type: 'list',
...
Builder.registerComponent(AchievementBadge, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F3c4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r',
  inputs: [
    {
      name: 'badgeType',
      type: 'string',
...
Builder.registerComponent(ProgressTracker, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s',
  inputs: [
    {
...
Builder.registerComponent(SettingsPanel, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s0t',
  inputs: [
    {
...
Builder.registerComponent(InteractiveQuiz, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F6f7g8h9i0j1k2l3m4n5o6p7q8r9s0t1u',
  inputs: [
    {
      name: 'questions',
      type: 'list',
...
Builder.registerComponent(ParentDashboard, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F7g8h9i0j1k2l3m4n5o6p7q8r9s0t1u2v',
  inputs: [
    {
      name: 'childId',
      type: 'string',
...
Builder.registerComponent(AIWordRecommendation, {
  ...
  image: 'https://cdn.builder.io/api/v1/image/assets%2Ff1a03f21e1554e5e98f80ac6900b0d2e%2F8h9i0j1k2l3m4n5o6p7q8r9s0t1u2v3w',
  inputs: [
    {
      name: 'learningLevel',
      type: 'string',
...
export const initializeBuilderRegistry = () => {
  console.log('✅ Builder.io component registry initialized with 9 educational components')
