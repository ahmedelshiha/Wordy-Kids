...
export const initializeBuilderRegistry = () => {
  ...
  // Note: Configuration removed as builder.configure() is not available in this version
  // Component registrations above are sufficient for basic Builder.io functionality
};
