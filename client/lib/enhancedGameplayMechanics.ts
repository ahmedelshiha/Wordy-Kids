...
export class PowerUpSystem {
  private static readonly POWER_UP_DEFINITIONS: Record<
    string,
    Omit<PowerUp, "currentUses" | "lastUsed" | "isActive">
  > = {
    "jungle-hint": {
      id: "jungle-hint",
      type: "hint",
...
export class AchievementSystem {
  private static readonly ACHIEVEMENT_DEFINITIONS: Achievement[] = [
    {
      ...
      requirements: [
        { type: "words-learned", operation: "greater-equal", value: 1 },
      ],
    ...
    },
    {
      ...
      rewards: [
        { type: "gems", value: 25 },
        { type: "power-up", value: "streak-multiplier" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      rewards: [
        { type: "gems", value: 50 },
        { type: "title", value: "Perfectionist" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      rewards: [
        { type: "gems", value: 40 },
        { type: "power-up", value: "time-boost" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      requirements: [
        { type: "categories-explored", operation: "greater-equal", value: 5 },
      ],
      rewards: [
        { type: "gems", value: 100 },
        { type: "avatar", value: "explorer-hat" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      category: "progression",
      requirements: [
        { type: "score", operation: "greater-equal", value: 1000 },
      ],
    ...
    },
    {
      ...
      category: "progression",
      requirements: [
        { type: "consecutive-days", operation: "greater-equal", value: 7 },
      ],
      rewards: [
        { type: "gems", value: 75 },
        { type: "theme", value: "golden-jungle" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      category: "progression",
      requirements: [
        { type: "score", operation: "greater-equal", value: 10000 },
      ],
      rewards: [
        { type: "title", value: "Jungle Legend" },
        { type: "special-effect", value: "crown-aura" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: false,
    ...
    },
    {
      ...
      category: "special",
      requirements: [
        { type: "perfect-games", operation: "greater-equal", value: 10 },
      ],
      rewards: [
        { type: "power-up", value: "auto-correct", rarity: "legendary" },
      ],
      isUnlocked: false,
      progress: 0,
      isSecret: true,
  ...
  public static checkAchievements(
    ...
    for (const achievement of this.ACHIEVEMENT_DEFINITIONS) {
      ...
      const prerequisitesMet = achievement.prerequisites.every(
        (prereqId) =>
          this.ACHIEVEMENT_DEFINITIONS.find((a) => a.id === prereqId)
            ?.isUnlocked,
      );
      ...
      if (requirementsMet) {
        ...
        // Update progress
        achievement.progress = this.calculateProgress(
  ...
  public static getAvailableAchievements(): Achievement[] {
    return this.ACHIEVEMENT_DEFINITIONS.filter(
...
export class ScoringSystem {
  ...
  public static calculateQuestionScore(
    ...
    const streakIndex = Math.min(
      streak,
      this.CONFIG.streakMultipliers.length - 1,
    );
  ...
  public static calculateLevelProgress(
    currentXP: number,
    level: number,
  ): {
...
export class GameSessionManager {
  ...
  public static updateSession(
    ...
    if (isCorrect) {
      ...
      updatedSession.maxStreak = Math.max(
        updatedSession.maxStreak,
        updatedSession.currentStreak,
      );
    } else {
  ...
  public static getSessionStats(session: GameSession): {
    ...
    const questionsPerMinute =
      duration > 0 ? (session.totalQuestions / duration) * 60 : 0;
