...
import { sanitizeTTSInput, createSafeUtterance, logSpeechError } from './speechUtils';
...
export function runSpeechSafetyTests(): void {
  ...
  console.log("✅ Test 1 - Valid string:", test1 === "hello world" ? "PASS" : "FAIL");

  // Test 2: String with whitespace
  const test2 = sanitizeTTSInput("  hello world  ");
  console.log("✅ Test 2 - String with whitespace:", test2 === "hello world" ? "PASS" : "FAIL");

  // Test 3: Object with word property
  const test3 = sanitizeTTSInput({ word: "test word", other: "ignored" });
  console.log("✅ Test 3 - Object with word property:", test3 === "test word" ? "PASS" : "FAIL");

  // Test 4: Object with text property
  const test4 = sanitizeTTSInput({ text: "test text", other: "ignored" });
  console.log("✅ Test 4 - Object with text property:", test4 === "test text" ? "PASS" : "FAIL");

  // Test 5: Plain object (should be serialized)
  const test5 = sanitizeTTSInput({ name: "John", age: 25 });
  console.log("✅ Test 5 - Plain object:", test5.includes("John") && test5.includes("25") ? "PASS" : "FAIL");
  ...
  console.log("✅ Test 10 - Safe utterance creation:", utterance1 instanceof SpeechSynthesisUtterance ? "PASS" : "FAIL");

  // Test 11: createSafeUtterance with invalid input
  const utterance2 = createSafeUtterance("");
  console.log("✅ Test 11 - Safe utterance with empty input:", utterance2 === null ? "PASS" : "FAIL");
  ...
  console.log("✅ Test 12 - Problematic object:", test12 !== "[object Object]" ? "PASS" : "FAIL");
...
if (typeof window !== 'undefined' && process.env.NODE_ENV === 'development') {
  ...
  console.log("💡 Run 'runSpeechSafetyTests()' in console to test speech input sanitization");
}
