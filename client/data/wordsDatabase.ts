...
export const wordsDatabase: Word[] = [
  ...
  },
  {
    ...
    definition: "A deep sleep that some animals take during winter to save energy",
    example: "Bears go into hibernation when food becomes scarce in winter",
    funFact: "During hibernation, a bear's heart rate drops from 40 beats per minute to just 8!",
    emoji: "🐻",
    category: "animals",
    difficulty: "medium",
    imageUrl: undefined
...
export const getRandomWords = (count: number, category?: string, difficulty?: 'easy' | 'medium' | 'hard'): Word[] => {
