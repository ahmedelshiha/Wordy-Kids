...
`;
  ...
  try {
    ...
    log(
      colors.yellow,
      `⚠️  Could not create development guide: ${error.message}`,
    );
...
function main() {
  ...
  log(
    colors.blue,
    "Configuring Git and development environment for proper emoji handling",
  );
  console.log("");
  ...
  if (!verifyEmojiFiles()) {
    ...
    log(
      colors.yellow,
      "💡 Make sure all emoji-related files have been created",
    );
    allStepsSuccessful = false;
  }
  console.log("");
  ...
  if (allStepsSuccessful) {
    ...
    log(
      colors.green,
      "Your repository is now configured for proper emoji handling:",
    );
    ...
    log(
      colors.blue,
      "🔒 The pre-commit hook will now automatically check for emoji corruption.",
    );
    ...
    log(
      colors.red,
      "Some steps failed during setup. Please review the errors above.",
    );
    log(
      colors.yellow,
      "You may need to manually complete some configuration steps.",
    );
    console.log("");
