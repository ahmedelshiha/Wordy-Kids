...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin !== location.origin && !url.hostname.includes('cdn.builder.io')) {
    return;
  }
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    badge: 'https://cdn.builder.io/api/v1/image/assets%2Fbebe97bf37d04293b70e6f9372d99db4%2F6a9f823070a947fe81ec12398fd564c5?format=webp&width=96',
    vibrate: [100, 50, 100],
    data: {
